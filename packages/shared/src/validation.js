...
function validateLockedVariants(items) {
    const errors = [];
...
export function validateRuleForm(input) {
    const errors = [];
    if (!hasTitle(input)) {
...
export function clampRuleDiscountInput(input) {
